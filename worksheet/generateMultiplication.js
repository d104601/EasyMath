function generateProblems(){
    ...
    if(numberOfDigits == '1' && document.getElementById('operandRestriction').checked==true)
    {
    ...
    while(i<=numberOfProblems)
    {
        ...
        if(document.getElementById('operandRestriction').checked==true){
            operand2 = document.getElementById('restrictedOperand').value;
        }
        else{
